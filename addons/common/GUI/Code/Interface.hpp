class GUICode_Interface
{
	...
	{
		class GUICode_Background: RscText_DISCommonGUI
		{
			idc = 2200;
		...
		class GUICode_Title: RscStructuredText_DISCommonGUI
		{
			idc = 1000;
			text = "<t valign='middle' align='center' size='2.4'>Title</t>";
	...
	class controls 
	{
		...
		class GUICode_C1: RscStructuredText_DISCommonGUI
		{
			idc = 2400;
		...
		class GUICode_C2: RscStructuredText_DISCommonGUI
		{
			idc = 2401;
		...
		class GUICode_C3: RscStructuredText_DISCommonGUI
		{
			idc = 2402;
		...
		class GUICode_C4: RscStructuredText_DISCommonGUI
		{
			idc = 2403;
...
///////////////////////////////////////////////
		class GUICode_Touche0: RscButton_DISCommonGUI
		{
			idc = 1600;
		...
		class GUICode_Touche1: RscButton_DISCommonGUI
		{
			idc = 1601;
		...
		class GUICode_Touche2: RscButton_DISCommonGUI
		{
			idc = 1602;
		...
		class GUICode_Touche3: RscButton_DISCommonGUI
		{
			idc = 1603;
		...
		class GUICode_Touche4: RscButton_DISCommonGUI
		{
			idc = 1604;
		...
		class GUICode_Touche5: RscButton_DISCommonGUI
		{
			idc = 1605;
		...
		class GUICode_Touche6: RscButton_DISCommonGUI
		{
			idc = 1606;
		...
		class GUICode_Touche7: RscButton_DISCommonGUI
		{
			idc = 1607;
		...
		class GUICode_Touche8: RscButton_DISCommonGUI
		{
			idc = 1608;
		...
		class GUICode_Touche9: RscButton_DISCommonGUI
		{
			idc = 1609;
		...
		class GUICode_Cancel: RscButton_DISCommonGUI
		{
			idc = 1610;
		...
		class GUICode_Confirm: RscButton_DISCommonGUI
		{
			idc = 1611;
